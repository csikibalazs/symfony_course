...
class PostControllerTest extends WebTestCase
{
    ...
    public function testShow()
    {
        ...
        $this->assertGreaterOrEqual(1, $crawler->filter('article.comment')->count(), 'there should be at least 1 comment');
    }
    ...
    public function testCreateComment()
    {
        ...
        $this->assertTrue(
            $client->getResponse()->isRedirect('/'.$post->getSlug(), 'No redirect')
        );
